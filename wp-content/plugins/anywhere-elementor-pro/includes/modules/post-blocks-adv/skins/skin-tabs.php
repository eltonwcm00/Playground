...
class Skin_Tabs extends Skin_Base
{
    ...
    public function render()
    {
        ...
        $this->parent->add_render_attribute( 'ae-post-blocks-adv-tabs-wrapper', [
            'class' => 'ae-post-blocks-adv-tabs-wrapper',
            'role' => 'tab'
        ] );

        $this->parent->add_render_attribute( 'ae-post-blocks-adv-tabs-content-wrapper', [
        ...
        <?php
            ...
            Frontend::$_in_repeater_block = true; ?>
                ...
                <?php
                    ...
                    $this->parent->set_render_attribute( 'ae-post-blocks-adv-tab-desktop-title', [
            ...
            <div <?php echo $this->parent->get_render_attribute_string('ae-post-blocks-adv-tabs-content-wrapper'); ?>>
                    <?php  while($posts->have_posts()){
                        $posts->the_post();
                        $this->parent->set_render_attribute( 'ae-post-blocks-adv-tab-mobile-title', [
                            'class' => 'ae-post-blocks-adv-tab-title ae-post-blocks-adv-tab-mobile-title',
                            'data-tab' => $counter,
                            'data-hashtag' => 'tab_' . $counter
                        ] );
                        $this->parent->set_render_attribute( 'ae-post-blocks-adv-tab-content', [
